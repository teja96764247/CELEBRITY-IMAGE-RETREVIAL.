...
feature_list = np.array(pickle.load(open('featured_array.pkl', 'rb')))
filenames = pickle.load(open('image_paths.pkl', 'rb'))
...
st.markdown("<h2 style='text-align: center;'>CELEBRITY IMAGE RETRIEVAL</h2>", unsafe_allow_html=True)
...
if file is None:
    ...
    original_col,col1,col2,col3,col4,col5=st.columns(6)
